    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Validating Guest Access</h2>
          <p className="text-white text-opacity-80">Please wait while we verify your guest access...</p>
        </div>
      </div>
    );
  }
