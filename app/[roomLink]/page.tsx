...
export default function ShortRoomAccess() {
  const params = useParams();
  const searchParams = useSearchParams();
  
  const roomLink = params.roomLink as string;
  const accessType = searchParams.get('h') !== null ? 'host' : searchParams.get('g') !== null ? 'guest' : null;
  ...
  console.log('🔍 Short Room Access Debug:', {
    ...
    hParam: searchParams.get('h'),
    gParam: searchParams.get('g'),
    accessType
  });
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Validating Room Access</h2>
          <p className="text-white text-opacity-80">Please wait while we verify your access...</p>
        </div>
      </div>
    );
  }
  ...
  console.log('🔗 Short Room Integration:', {
